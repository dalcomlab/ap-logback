 ...
 */
package com.dalcomlab.logback.classic.pattern.color;

import com.dalcomlab.logback.classic.Level;
import com.dalcomlab.logback.classic.spi.ILoggingEvent;
import com.dalcomlab.logback.core.pattern.color.ForegroundCompositeConverterBase;

import static com.dalcomlab.logback.core.pattern.color.ANSIConstants.*;
