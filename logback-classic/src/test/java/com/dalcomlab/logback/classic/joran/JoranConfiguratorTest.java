...
import com.dalcomlab.logback.classic.jul.JULHelper;
import com.dalcomlab.logback.classic.spi.ILoggingEvent;
import com.dalcomlab.logback.classic.turbo.DebugUsersTurboFilter;
import com.dalcomlab.logback.classic.turbo.NOPTurboFilter;
import com.dalcomlab.logback.classic.turbo.TurboFilter;
...
import com.dalcomlab.logback.core.pattern.parser.Parser;
import com.dalcomlab.logback.core.read.ListAppender;
import com.dalcomlab.logback.core.spi.ScanException;
...
import com.dalcomlab.logback.core.util.CachingDateFormatter;
...
public class JoranConfiguratorTest {
    ...
    public void appenderRefSettingBySystemProperty() throws JoranException {
        ...
        final Logger logger = loggerContext.getLogger("com.dalcomlab.logback.classic.joran");
    ...
    public void timestampLocal() throws JoranException, IOException, InterruptedException {
        ...
        String sysProp = "com.dalcomlab.logback.classic.joran.JoranConfiguratorTest.timestampLocal";
