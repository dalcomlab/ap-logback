...
import com.dalcomlab.logback.classic.testUtil.SampleConverter;
...
import com.dalcomlab.logback.core.pattern.parser.AbstractPatternLayoutBaseTest;
...
import static com.dalcomlab.logback.classic.ClassicTestConstants.ISO_REGEX;
import static com.dalcomlab.logback.classic.ClassicTestConstants.MAIN_REGEX;
...
public class PatternLayoutTest extends AbstractPatternLayoutBaseTest<ILoggingEvent> {
    ...
    ILoggingEvent makeLoggingEvent(String msg, Exception ex) {
        return new LoggingEvent(com.dalcomlab.logback.core.pattern.FormattingConverter.class.getName(), logger, Level.INFO, msg, ex, null);
    }
    ...
    public void testOK() {
        ...
        String regex = ISO_REGEX + " INFO " + MAIN_REGEX + " c.d.l.c.pattern.ConverterTest - Some message\\s*";
    ...
    public void testCompositePattern() {
        ...
        String regex = ISO_REGEX + " c.d.l.c.p.ConverterTest          - Some message\\s*";
