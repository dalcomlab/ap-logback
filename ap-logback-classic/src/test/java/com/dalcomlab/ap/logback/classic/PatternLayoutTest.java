...
import com.dalcomlab.ap.logback.classic.pattern.ConverterTest;
...
import com.dalcomlab.ap.logback.core.pattern.PatternLayoutBase;
import com.dalcomlab.ap.logback.core.pattern.parser.AbstractPatternLayoutBaseTest;
...
import static com.dalcomlab.ap.logback.classic.ClassicTestConstants.ISO_REGEX;
import static com.dalcomlab.ap.logback.classic.ClassicTestConstants.MAIN_REGEX;
...
public class PatternLayoutTest extends AbstractPatternLayoutBaseTest<ILoggingEvent> {
    ...
    ILoggingEvent makeLoggingEvent(String msg, Exception ex) {
        return new LoggingEvent(com.dalcomlab.ap.logback.core.pattern.FormattingConverter.class.getName(), logger, Level.INFO, msg, ex, null);
    }
    ...
    @Test
    public void testOK() {
        pl.setPattern("%d %le [%t] %lo{32} - %m%n");
        pl.start();
        ...
        String regex = ISO_REGEX + " INFO " + MAIN_REGEX + " c.d.a.l.c.pattern.ConverterTest - Some message\\s*";
    ...
    public void testCompositePattern() {
        pl.setPattern("%-58(%d %lo{20}) - %m%n");
        pl.start();
        String val = pl.doLayout(getEventObject());
        // 2008-03-18 21:55:54,250 c.q.l.c.pattern.ConverterTest - Some message
        String regex = ISO_REGEX + " c.d.a.l.c.p.ConverterTest          - Some message\\s*";
