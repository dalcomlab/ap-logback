...
import com.dalcomlab.ap.logback.core.boolex.JaninoEventEvaluatorBase;
import com.dalcomlab.ap.logback.core.boolex.Matcher;
...
public class JaninoEventEvaluatorTest {
    ...
    LoggingEvent makeLoggingEvent(Exception ex) {
        return new LoggingEvent(com.dalcomlab.ap.logback.core.pattern.FormattingConverter.class.getName(), logger, Level.INFO, "Some message", ex, null);
    }
