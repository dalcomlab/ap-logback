 ...
 */
package com.dalcomlab.ap.logback.classic.jmx;
...
public class JMXConfiguratorTest {
    ...
    public void contextReset() throws Exception {
        String randomizedObjectNameAsStr = "com.dalcomlab.ap.logback." + diff + ":Name=" + lc.getName() + ",Type=" + this.getClass().getName();
    ...
    public void testNonRemovalOfPreviousIntanceFromTheContextListenerList() {
        String objectNameAsStr = "com.dalcomlab.ap.logback.toto" + ":Name=" + lc.getName() + ",Type=" + this.getClass().getName();
