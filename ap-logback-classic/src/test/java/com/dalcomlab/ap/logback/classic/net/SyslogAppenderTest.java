...
import com.dalcomlab.ap.logback.classic.net.SyslogAppender;
import com.dalcomlab.ap.logback.classic.net.mock.MockSyslogServer;
...
import com.dalcomlab.ap.logback.core.recovery.RecoveryCoordinator;
...
public class SyslogAppenderTest {
    ...
    public void tException() throws InterruptedException {
        ...
        assertTrue(msg.startsWith(expected));
        regex = SYSLOG_PREFIX_REGEX + "\\[" + threadName + "\\] " + "foo " + CoreConstants.TAB + "at com\\.dalcomlab\\.ap.*";
        checkRegexMatch(msg, regex);
    }
