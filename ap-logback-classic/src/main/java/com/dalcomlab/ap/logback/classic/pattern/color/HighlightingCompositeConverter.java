 ...
 */
package com.dalcomlab.ap.logback.classic.pattern.color;

import com.dalcomlab.ap.logback.classic.Level;
import com.dalcomlab.ap.logback.classic.spi.ILoggingEvent;
import com.dalcomlab.ap.logback.core.pattern.color.ForegroundCompositeConverterBase;

import static com.dalcomlab.ap.logback.core.pattern.color.ANSIConstants.*;
