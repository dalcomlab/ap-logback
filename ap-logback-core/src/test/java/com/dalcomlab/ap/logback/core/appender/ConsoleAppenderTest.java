...
import com.dalcomlab.ap.logback.core.encoder.DummyEncoder;
import com.dalcomlab.ap.logback.core.encoder.EchoEncoder;
import com.dalcomlab.ap.logback.core.encoder.NopEncoder;
import com.dalcomlab.ap.logback.core.layout.DummyLayout;
...
public class ConsoleAppenderTest extends AbstractAppenderTest<Object> {
    ...
    public void wrongTarget() {
        ...
        // 21:28:01,246 + WARN in com.dalcomlab.ap.logback.core.ConsoleAppender[null] - [foo] should be one of [System.out,
        // System.err]
        // 21:28:01,246 |-WARN in com.dalcomlab.ap.logback.core.ConsoleAppender[null] - Using previously set target, System.out by
        // default.
